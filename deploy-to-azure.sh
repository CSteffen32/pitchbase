...
echo ""
echo "To set them via CLI (replace PASSWORD with your actual DB password):"
echo ""
...
echo "    DATABASE_URL=\"postgresql://$DB_ADMIN:PASSWORD@$DB_HOST:5432/postgres?schema=public&sslmode=require\" \\"
echo "    DIRECT_URL=\"postgresql://$DB_ADMIN:PASSWORD@$DB_HOST:5432/postgres?schema=public&sslmode=require\" \\"
